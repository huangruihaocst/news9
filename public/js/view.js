...
$(document).ready(function(){
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            //for(var j = 0;j < scaled.length; ++j){
            //    var original_width = scaled[j].clientWidth;
            //    var original_height = scaled[j].clientHeight;
            //    console.log(original_width);
            //}

            //if(original_height > original_width){
            //    scaled.height(MAX_SIZE);
            //    scaled.width();
            //}else{
            //    scaled.width(MAX_SIZE);
            //    scaled.height(MAX_SIZE * original_height / original_width);
            //}
        }
    });
});